...
// URL theke Movie ID neya
const urlParams = new URLSearchParams(window.location.search);
const movieId = urlParams.get('id');

async function getMovieDetails() {
    if (!movieId) {
        detailsContainer.innerHTML = "<h2>No Movie ID found!</h2>";
        return;
    }
    ...
    try {
        ...
        detailsContainer.innerHTML = "<h2>Something went wrong. Please try again later.</h2>";
    }
}
